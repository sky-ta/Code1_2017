...
//char Keys[] =   {  'x',    'z',    ' ',     '\r',    'd',     'w',    'a',    's'};

//char keys for Binding of Isaac:
char Keys[] =   {  KEY_RIGHT_ARROW, KEY_UP_ARROW, KEY_DOWN_ARROW, KEY_LEFT_ARROW,  'd',     'w',    'a',    's'};

// arrow D-pad, select = Return, start = Space, LeftButton = b, RightButton = a
//char Keys[] =   {  'a',    'b',    ' ',    '\r' , KEY_RIGHT_ARROW, KEY_UP_ARROW, KEY_LEFT_ARROW, KEY_DOWN_ARROW};
